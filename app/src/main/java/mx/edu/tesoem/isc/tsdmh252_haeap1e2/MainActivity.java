package mx.edu.tesoem.isc.tsdmh252_haeap1e2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnp1saluda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MainActivity.this, "Bienvenido a la programacion en Android " + cajanombre.getText(), Toast.LENGTH_LONG).show();
            }
        });
